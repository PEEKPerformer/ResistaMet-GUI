...
# --- reading parse and row building -----------------------------------------
# Called per sample by the acquisition loop. Like the configure functions, they
# take the instrument state they need explicitly and never touch a worker.
...
# worker — the headless session calls the same functions.
